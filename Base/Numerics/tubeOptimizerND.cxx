...
::Extreme( VectorType & x, double * xVal )
{
  ...
  while( vnl_math::abs( a ) > m_Tolerance )
    {
    ...
    double xstep = vnl_math::abs( dot_product( m_XStep, m_X0Dir ) );
  ...
  MatrixType & directions )
{
  ...
  for( unsigned int i=0; i<m_MaxLineSearches; i++ )
    ...
    xstep = vnl_math::abs( dot_product( m_XStep, m_X0Dir ) );
