    ...
    if( maskIsSet )
      ...
      if( physDist <= physKernelRadiusSquared )
        ...
        for( unsigned int i = 0; i <  ImageDimension; i++ )
          ...
          dTotal[i] += vnl_math::abs( expValueD );
          }
        }
      }
    ...
    if( maskIsSet )
      ...
      if( physDist <= physKernelRadiusSquared )
        ...
        for( unsigned int i = 0; i < ImageDimension; i++ )
          ...
          hTotal[i][i] += vnl_math::abs( expValueD );
          ...
          for( unsigned int j=i+1; j< ImageDimension; j++ )
            ...
            hTotal[i][j] += vnl_math::abs( expValueD );
            }
          }
        }
      }
